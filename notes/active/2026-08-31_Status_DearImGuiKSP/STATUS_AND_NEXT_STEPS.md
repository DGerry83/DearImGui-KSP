...
| M5 Settings + lifecycle + failure UX | C11–C13 | **C11 DONE (AC12 PASS)**; **C12 DONE (AC10 PASS in-game 2026-08-31)**. C13 (failure popup) next. Follow-ups: ISSUES #002 (window anchor on resolution change, P3) |
...
3. **C13** failure notifier (AC8) — **paused here 2026-08-31 at user request**; resume by writing CHUNK_13_CONTRACT.md. ~~C12~~ DONE (AC10 PASS).
