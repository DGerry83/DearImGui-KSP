...
| C8 | **Implemented** — awaiting user in-game verification | `DearImGuiKSPDemo/DemoConsumer.cs` | `dotnet build` 0 err/0 warn (2026-08-31); AC3/AC4 pending user in-game check | G2 (C8 contract): PASS; G3 (C8): PASS; G6 (AC3/AC4): PENDING | Implemented directly by lead (HANDOFF §7 allows); contract: CHUNK_8_CONTRACT.md. Window non-interactive until C9 — expected. Demo registers in `Start()`, unregisters in `OnDestroy()`, exercises Text/Button/SliderFloat/InputText |
| C9 | Pending | - | - | - | - |
| C10 | Pending | - | - | - | - |
| C11 | Pending | - | - | - | - |
| C12 | Pending | - | - | - | - |
