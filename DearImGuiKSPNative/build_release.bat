...
cl /nologo /EHsc /std:c++17 /O2 /DNDEBUG /Iinclude /Ivendor /Ivendor\imgui_toggle /Ivendor\implot /Ivendor\cimplot /I..\..\cimgui /I..\..\cimgui\imgui /I..\..\cimgui\imgui\backends /LD src\DearImGuiKSPNative.cpp src\ContextHost.cpp src\BackendD3D11.cpp src\shims\imgui_toggle_shim.cpp vendor\imgui_toggle\imgui_toggle.cpp vendor\imgui_toggle\imgui_toggle_palette.cpp vendor\imgui_toggle\imgui_toggle_presets.cpp vendor\imgui_toggle\imgui_toggle_renderer.cpp vendor\implot\implot.cpp vendor\implot\implot_items.cpp vendor\implot\implot_demo.cpp vendor\cimplot\cimplot.cpp ..\..\cimgui\cimgui.cpp ..\..\cimgui\imgui\imgui.cpp ..\..\cimgui\imgui\imgui_draw.cpp ..\..\cimgui\imgui\imgui_tables.cpp ..\..\cimgui\imgui\imgui_widgets.cpp ..\..\cimgui\imgui\imgui_demo.cpp ..\..\cimgui\imgui\backends\imgui_impl_dx11.cpp /Fe:build\DearImGuiKSPNative.dll /Fo:build\ /link /DLL d3d11.lib dxgi.lib
