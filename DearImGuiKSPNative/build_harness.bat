...
cl /nologo /EHsc /std:c++17 /O2 /DNDEBUG /Isrc /Ivendor\imgui_toggle /I..\..\cimgui /I..\..\cimgui\imgui src\ContextHost.cpp src\shims\imgui_toggle_shim.cpp vendor\imgui_toggle\imgui_toggle.cpp vendor\imgui_toggle\imgui_toggle_palette.cpp vendor\imgui_toggle\imgui_toggle_presets.cpp vendor\imgui_toggle\imgui_toggle_renderer.cpp harness\harness_main.cpp ..\..\cimgui\cimgui.cpp ..\..\cimgui\imgui\imgui.cpp ..\..\cimgui\imgui\imgui_draw.cpp ..\..\cimgui\imgui\imgui_tables.cpp ..\..\cimgui\imgui\imgui_widgets.cpp ..\..\cimgui\imgui\imgui_demo.cpp /Fe:build\harness.exe /Fo:build\intermediate-harness\ /Fd:build\intermediate-harness\
