...
cl /nologo /EHsc /std:c++17 /O2 /DNDEBUG /LD src\DearKSPNative.cpp /Fe:build\DearKSPNative.dll /Fo:build\ /link /DLL
...
echo DearKSPNative.dll (release) -^> GameData\DearKSP\Plugins\
